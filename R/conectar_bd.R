...
#'
#' Esta funcion establece una conexión con una base de datos SQLite especificada por la ruta del archivo.
...
#' @return Un objeto de clase `DBIConnection`, que es la conexion abierta con la base de datos.
#' @export
#'
#' @examples
#' conn <- conectar_bd("mi_base_de_datos.sqlite3")
conectar_bd <- function(db_path = "data/db.sqlite3") {
