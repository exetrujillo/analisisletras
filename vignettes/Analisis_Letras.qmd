...
1.  Un corpus de quanteda

2.  Los tokens de quanteda generados a partir del corpus

3.  Un set de stopwords combinadas entre las standard en español y las que se agreguen adhok.

4.  Una matriz de documento-término generada a partir de los tokens

5.  Cálculo de frecuencias

6.  Cálculo de frecuencias de bigramas

7.  Cálculo de frecuencias de trigramas
